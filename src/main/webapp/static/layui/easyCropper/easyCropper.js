...
layui.config({
    ...
    var obj = {
        ...
        render: function(e){
            ...
            // 注意更改这里css的路径
            var cropperHtml = '<link rel="stylesheet" href="'+contextPath+'layui/easyCropper/cropper.css">\n' +
                ...
                '            <div style="overflow:hidden;width:200px;height:200px;background-color: rgb(247, 247, 247);">\n' +
                '                <img id="'+imageId+'" src="'+defaultImg+'"  hidden="hidden">\n' +
                '            </div>\n' +
                '        </div>\n' +
                '        <div class="layui-col-xs5">\n' +
                '            <div id="'+previewId+'" style="overflow:hidden;width:200px;height:200px;border: 1px solid rgb(200, 200, 200);">\n' +
                '            </div>\n' +
                '        </div>\n' +
                '    </div>\n' +
                '    <div class="layui-row layui-col-space15">\n' +
