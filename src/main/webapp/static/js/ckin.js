...
var iconPlay = '<i class="layui-icon layui-icon-play"></i>';
var iconPause = '<i class="layui-icon layui-icon-pause"></i>';
var iconVolumeMute = '<i class="layui-icon layui-icon-voice"></i>';
var iconVolumeMedium = '<i class="layui-icon layui-icon-voice"></i>';
var iconVolumeLow = '<i class="layui-icon layui-icon-voice"></i>';
var iconExpand = '<i class="layui-icon layui-icon-layer"></i>';
var iconCompress = '<i class="layui-icon layui-icon-layer"></i>'
