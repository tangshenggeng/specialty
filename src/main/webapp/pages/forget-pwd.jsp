...
<body>
	<div class="register_con">
		<div class="l_con fl">
			<a class="reg_logo"  href="${PATH}/pages/index.jsp"><img style="border:0;width:100px;height:75px;" src="${PATH}/pages/images/logo.png"></a>
		...
		<div class="r_con fr">
			...
			<div class="reg_form clearfix">
				<form action="${PATH}/customer/forgetPwd" method="post">
				<ul>
					<li>
						<label>邮箱:</label>
