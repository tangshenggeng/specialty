		...
		<div class="layui-body">
			<blockquote class="layui-elem-quote">
				<a href="${PATH}/admin/index"><i
					class="layui-icon layui-icon-layer"></i> 主页</a> / <a>下架商品</a>
			</blockquote>
					...
					<div class="card">
						<div class="card-header">
							...
							<button class="layui-btn layui-btn-warm" type="button"
								id="showByIds">
								<i class="layui-icon layui-icon-upload-circle"></i>选中上架
							</button>
						</div>
						<div class="card-body">
