...
<body class="layui-layout-body">
		...
		<div class="layui-body">
			<blockquote class="layui-elem-quote">
				<a href="${PATH}/admin/index"><i
					class="layui-icon layui-icon-layer"></i> 主页</a> / <a>合作中</a>
			</blockquote>
			<form class="layui-form" id="kwCustForm">
				<div class="layui-col-md4">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="text" name="coopIdent" placeholder="请输入"
								autocomplete="off" class="layui-input">
						</div>
					</div>
					...
					<div class="card">
						<div class="card-header">
							...
							<button class="layui-btn" type="button"
								id="stopByIds">
								<i class="layui-icon layui-icon-close"></i>停止合作
							</button>
						</div>
						<div class="card-body">
  ...
  <div class="layui-btn-container">
	...
	<script>
		...
		function renderTb() {
			...
			layui.use([ 'table', 'util', 'form' ], function() {
				...
				table.render({
					elem : '#dataListTb',
					height : 500,
					url : '${PATH}/cooperation/getCooperatingList',
					text : {
						none : '未找到数据'
					},
					id : "datListTbId",
		...
		//批量停止合作
		$("#stopByIds").click(function() {
			layui.use([ 'table', 'layer' ], function() {
				var table = layui.table, layer = layui.layer;
				layer.confirm('真的停止合作行么', function(index) {
					var checkStatus = table.checkStatus('dataListTbId');
					var datas = checkStatus.data
					var ids = new Array();
					$(datas).each(function() {
					...
					$.ajax({
						url : "${PATH}/cooperation/stopCoopByIds",
						method : "POST",
						contentType : "application/json",//必须指定，否则会报415错误
						dataType : 'json',
						data : JSON.stringify(ids),
  ...
  <a class="layui-btn layui-btn-xs layui-btn-normal" lay-event="cooperation">修改合作时间</a>
</script>
</body>
</html>